/*Descripción: Implemento un LinkedList para hacer este ejercicio
...
public class PrincipalAgenda {
	...
	public static void main(String[] args) {
		...
		LinkedList<Agenda> agenda = new LinkedList<Agenda>();
		...
		do {
			...
			if (eleccion.equals("a")) {
				...
				Collections.sort(agenda, new ComparadorAgenda());
