...
public class Ejercicio2 {
	...
	public static void main(String[] args) {
		...
		LinkedList<Agenda> agenda = new LinkedList<>();
	...
	public static void generarContactos(LinkedList<Agenda> agenda) {
		Random r = new Random();
	...
	public static void insertarContacto(LinkedList<Agenda> agenda, Scanner sc) {
	...
	public static void buscarNombre(LinkedList<Agenda> agenda, Scanner sc) {
	...
	// metodo para ordenar
	private static void mostrarOrdenados(LinkedList<Agenda> agenda) {
		Collections.sort(agenda, Comparator.comparing(Agenda::getNombre));
	...
	private static void buscarPorAnno(LinkedList<Agenda> agenda, Scanner sc) {
